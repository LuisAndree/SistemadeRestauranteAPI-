...
api.busca = function(req, res) {
   db.findOne({_id: req.params.pratoId }, function(err, doc) {
        if (err) return console.log(err);
...
api.atualiza = function(req, res) {
    ...
    db.update({_id : req.params.pratoId }, req.body, function(err, numReplaced) {
        if (err) return console.log(err);
...
api.remove = function(req, res) {
    ...
    db.remove({ _id: req.params.pratoId }, {}, function (err, numRemoved) {
        if (err) return console.log(err);
